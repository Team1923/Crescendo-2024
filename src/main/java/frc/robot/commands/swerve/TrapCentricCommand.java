...
public class TrapCentricCommand extends Command {
  ...
  public TrapCentricCommand(CommandSwerveDrivetrain swerve, DoubleSupplier t, DoubleSupplier s, DoubleSupplier r) {
    this.swerve = swerve;
