...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public double calculateIntakeFeedForward(){
    return IntakeConstants.intakeMaxGravityConstant * Math.cos(getIntakeArmPosition());
  }
  ...
  public double getRawIntakeArmCurrent(){
    return intakeArmPrimary.getStatorCurrent().getValueAsDouble();
  }
  ...
  public boolean isAtIntakeState(IntakeStates intakeStates){
    return Math.abs(getIntakeArmPosition() - intakeStates.getIntakePosition().getAngularSetpoint()) < IntakeConstants.intakeStateThreshold;
  }
