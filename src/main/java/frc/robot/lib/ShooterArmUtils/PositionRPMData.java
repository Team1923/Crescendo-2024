...
public class PositionRPMData {
    ...
    public static synchronized PositionRPMData getInstance() {
     ...
     private void fillMaps() {
        ...
        speakerPositionRPMMap.put(176.3, new PositionRPMObject(-0.17 + ArmConstants.armPositionChange, 3750));
        speakerPositionRPMMap.put(182.6, new PositionRPMObject(-0.165 + ArmConstants.armPositionChange, 3825));
        speakerPositionRPMMap.put(186.6 , new PositionRPMObject(-0.155 + ArmConstants.armPositionChange, 4000));
